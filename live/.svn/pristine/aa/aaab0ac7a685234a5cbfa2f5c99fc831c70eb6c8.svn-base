...
<script type="text/javascript">
  function reloadTable(){
      var url_hasil="<?php echo base_url()?>master/data_tindakan_perawat/loaddata"
  ...
  $(function(){
      ...
      $.ajax({
        url: '<?php echo base_url()?>master/data_tindakan_perawat/loaddata',
        type: "POST",
        crossDomain: true,
      ...
      $('.submit').click(function(){
          isvalid = $("form.tambahData").validate({
            ...
            submitHandler: function(form) {
                ...
                $.post( "<?=base_url()?>master/data_tindakan_perawat/create",formdata).done(function(){
      ...
      $('.submitEdit').live("click",function(){
          ...
          crsf = $('.crsf').val();
          url = "<?=base_url()?>master/data_tindakan_perawat/update";
          datapost = "csrf_jike_2012="+crsf+"&ds[diagnosis_name]="+ds_name+"&ds[diagnosis_id]="+ds_id;
    ...
    <form class="stdform form-horizontal tambahData" style="display:none" method="post" >
      ...
      <div class="span5">
        <div class="widget-box">
          ...
          <div class="controls">
            <input type="text" autofocus="" name="ds[diagnosis_name]" id="ds_name" placeholder="Nama Tindakan" size="50">
          </div>          
        ...
        <div class="widgetbox">
            ...
            <?=form_open(cur_url().'search',array('class' => 'form-horizontal frm_search stdform','id' => 'form')); ?>
              <div class="chatsearch" >
                  <input type="text" class='searchname' name="" placeholder="Cari Tindakan" style="width:91%;margin:auto;">
              </div>
