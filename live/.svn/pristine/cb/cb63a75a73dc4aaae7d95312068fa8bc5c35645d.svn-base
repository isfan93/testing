...
<script type="text/javascript">
  function reloadTable(){
      var url_hasil="<?php echo base_url()?>master/data_fee_racikan/loaddata"
      $(".list_fee_racikan").load(url_hasil);
  }
  ...
  $(function(){
            ...
            if (r == true) {
                  ...
                  $(".black_loader").fadeIn(300).fadeOut(function(){
                    // console.log($(t).attr('href'));
                     $.ajax({
                        url: "<?php echo base_url()?>master/data_fee_racikan/delete_list",
      ...
      $('.list_fee_racikan').children().remove();
      $.ajax({
        url: '<?php echo base_url()?>master/data_fee_racikan/loaddata',
        type: "POST",
        crossDomain: true,
      ...
      $('.submit').click(function(){
          isvalid = $("form.tambahData").validate({
            ...
            submitHandler: function(form) {                
                ...
                $(".black_loader").fadeIn(300).fadeOut(function(){
                  $.post( "<?=base_url()?>master/data_fee_racikan/create",formdata).done(function(){
      ...
      $('.submitEdit').live("click",function(){
          ...
          crsf = $('.crsf').val();
          url = "<?=base_url()?>master/data_fee_racikan/update";
  ...
  <div class="row-fluid">
    <div class="span12">
      ...
      <div class="black_loader">
        ...
        <div class="row-fluid list_fee_racikan">
