...
<script type="text/javascript">
  function reloadTable(){
      var url_hasil="<?php echo base_url()?>master/data_treat_pack/loaddata_detail/"+$('#pt_id').val();
  ...
  $(function(){
		//autocomplete obat
 		...
 		$('#treat_name').autocomplete({
				source:BASE+'master/data_treat_pack/list_treat', 
				minLength:2,
	...
	//end autocomplete
      ...
      $.ajax({
        url: '<?php echo base_url()?>master/data_treat_pack/loaddata_detail/'+$('#pt_id').val(),
        type: "POST",
        crossDomain: true,
      ...
      $('.submit').click(function(){
          isvalid = $("form.tambahData").validate({
            ...
            submitHandler: function(form) {                
                ...
                $(".black_loader").fadeIn(300).fadeOut(function(){
                  $.post( "<?=base_url()?>master/data_treat_pack/create_detail",formdata).done(function(){
...
<div class="container-fluid" style="padding:0px;">
  <div class="row-fluid">
      <div class="pageheader notab">
          ...
          <!--a class="btn btn-primary" style="float:right;" href="<?=base_url()?>master/data_treat_pack">back</a-->
      </div>
  </div>
  <br clear="all">
