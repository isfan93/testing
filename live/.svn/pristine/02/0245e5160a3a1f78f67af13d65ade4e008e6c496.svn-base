...
<script type="text/javascript" charset="utf-8">
	...
	$(function(){
		...
		var d_uri = "<?=base_url()?>gudang/receive_item/get_receive_item";
	...
	<div class="row-fluid">
		<div class="span7">
            <div class="widgetbox" style="float:left;padding-top:20px;padding-left:20px;">
				<a href="<?php echo(cur_url())?>add_receive_item" class="btn btn-primary">
		...
		<div class="widgetbox">
			<div class="span12">
				...
				<table class="table table-bordered table-striped table_tr tb_scrol" id="dyntable">
				    <thead>
				        <tr>
				        	<th style="width:10% !important;">No. Receive Item</th>
				            <th style="width:13% !important;">Tanggal Penerimaan</th>
				            <th style="width:15% !important;">Supplier</th>
				            <th style="width:13% !important;">Petugas</th>
				            <th style="width:10% !important;">Nomor PO</th>
				            <th style="width:13% !important;">Tanggal Pemesanan</th>
