...
<script type="text/javascript" charset="utf-8">
    $(document).ready(function() {
        oTable = $('#todayVisit').dataTable({
            ...
            "aoColumnDefs": [
                  { "bSortable": true, "aTargets": [ 0 ], "sWidth": "17%"},
            ...
            "sAjaxSource": "<?= base_url() ?>rekam_medis/get_kunjungan_aktif/",
            ...
            "fnDrawCallback": function() {
                ...
                $("#todayVisit tbody td:nth-child(3)").addClass('left');
                $("#todayVisit tbody td:nth-child(4)").wrapInner('<i />');
                $("#todayVisit tbody td:nth-child(4)").addClass('center');
                $("#todayVisit tbody td:nth-child(5)").addClass('center');
            }
        });
        setInterval(function () {
            oTable.fnReloadAjax("<?= base_url() ?>rekam_medis/get_kunjungan_aktif/");
        }, 30000);
