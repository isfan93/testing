...
<script type="text/javascript">
  function reloadTable(){
      var url_hasil="<?php echo base_url()?>master/data_tindakan_perawat/loaddata_detail/"+$('#ds_id').val();
      $(".list_tindakan_keperawatan").load(url_hasil);
  }

  function resetInput(){
      $('#dsd_name').select2('val','');
  }
  $(function(){
		$("#dsd_name").select2({
            ...
            ajax: {
                url: BASE+"master/data_tindakan_perawat/get_tindakan",
                dataType: 'json',
                type: "GET",
                quietMillis: 50,
                data: function (term) {
    ...
    $('#dsd_name').change(function(){
            ...
            if (r == true) {
                  ...
                  $(".black_loader").fadeIn(300).fadeOut(function(){
                    // console.log($(t).attr('href'));
                     $.ajax({
                        url: "<?php echo base_url()?>master/data_tindakan_perawat/delete_list",
      ...
      $('.list_tindakan_keperawatan').children().remove();
      $.ajax({
        url: '<?php echo base_url()?>master/data_tindakan_perawat/loaddata_detail/'+$('#ds_id').val(),
        type: "POST",
        crossDomain: true,
        ...
        success: function( data ) {
          ...
          $('.list_tindakan_keperawatan').append(data);
        }
      });
      ...
      $('.submit').click(function(){
          isvalid = $("form.tambahData").validate({
            ...
            submitHandler: function(form) {                
                ...
                //$(".black_loader").fadeIn(300).fadeOut(function(){
                  $.post( "<?=base_url()?>master/data_tindakan_perawat/create_detail",formdata).done(function(){
...
<div class="container-fluid" style="padding:0px;">
  <div class="row-fluid">
      <div class="pageheader notab">
          <h2 class="pagetitle"><?=$konten['diagnosis_name']?></h2>
          
      </div>
  </div>
  <br clear="all">
  <!--a class="btn btn-primary" style="float:right;" href="<?=base_url()?>master/data_tindakan_perawat">back</a-->
  <div class="page-content row-fluid">
    <form class="stdform form-horizontal tambahData" style="display:none" method="post" >
	  ...
	  <input type="hidden" name="ds[diagnosis_id]" id="ds_id" value="<?= $konten['diagnosis_id']?>">
      <div class="span5">
        <div class="widget-box">
          ...
          <div class="controls">
            ...
            <input type="hidden" name="ds[treatment_id]" id="dsd_id" class="" value="">
  ...
  <div class="row-fluid">
    <div class="span12">
      ...
      <div class="black_loader">
        ...
        <div class="row-fluid list_tindakan_keperawatan">
