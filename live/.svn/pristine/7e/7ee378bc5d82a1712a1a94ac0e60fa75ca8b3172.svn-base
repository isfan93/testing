...
<div class="pageheader notab">
  <div class="row-fluid">
    ...
    <div class="span6">
      <form class="form-inline" id="getCashflow" action="<?=base_url()?>pelaporan/keuangan/getCashflow" method="POST">
...
<script type="text/javascript">
  $(function(){
    $("#getCashflow").on('submit',function(){
      $.blockUI({
