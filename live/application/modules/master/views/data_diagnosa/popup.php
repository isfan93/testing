			 ...
			 $.ajax({
				...
				success: function() {
					...
					/*$('.close').click();
					 ...
					 //tbldokter.fnDraw();
					$('.list_tindakan').load('master/data_diagnosa/loaddata');
					$('#myModal').modal('togle');
				},
				/*error:function(){
                        ...
                        <div class='span12' >
                            ...
                            <div class="control-group" style="border:none;">
                                ...
                                <div class="controls input-medium" >
                                    <input type="text" class='' required name="mst[diag_id]" id="kode">
                                </div>
                            </div>
							<div class="control-group" style="border:none;">
                                <label class="control-label" style="width:20%;">Diagnosa</label>
                                <div class="controls" >
