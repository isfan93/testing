...
<script type="text/javascript">
  function reloadTable(){
      var url_hasil="<?php echo base_url()?>master/data_diagnosa/loaddata"
      $(".list_diagnosa").load(url_hasil);
  }
  ...
  $(function(){
            ...
            if (r == true) {
                  ...
                  $(".black_loader").fadeIn(300).fadeOut(function(){
                    // console.log($(t).attr('href'));
                     $.ajax({
                        url: "<?php echo base_url()?>master/data_diagnosa/delete_list",
      ...
      $('.list_diagnosa').children().remove();
      $.ajax({
        url: '<?php echo base_url()?>master/data_diagnosa/loaddata',
        type: "POST",
        crossDomain: true,
      ...
      $('.submit').click(function(){
          isvalid = $("form.tambahData").validate({
            ...
            submitHandler: function(form) {                
                ...
                $(".black_loader").fadeIn(300).fadeOut(function(){
                  $.post( "<?=base_url()?>master/data_diagnosa/create",formdata).done(function(){
      ...
      $('.submitEdit').live("click",function(){
          t = this;
          ins_id =  $(this).parent().parent().parent().find('.diag_id').val();
          ins_kode =  $(this).parent().parent().parent().find('.dsim_kode').val();
		  ins_name =  $(this).parent().parent().parent().find('.dsim_name').val();
		  ins_desc =  $(this).parent().parent().parent().find('.dsim_desc').val();
          
          crsf = $('.crsf').val();
          url = "<?=base_url()?>master/data_diagnosa/update";
          datapost = "csrf_jike_2012="+crsf+"&ds[diag_name]="+ins_name+"&ds[diag_id]="+ins_id+"&ds[diag_kode]="+ins_kode+"&ds[description]="+ins_desc;
      ...
      <div class="span11">
        <div class="widget-box">
          <div class="widget-title">
            ...
            <h5>Tambah Data Diagnosa</h5>
          </div>
          <div class="control-group" style="border:none;">
          <label class="control-label">Kode</label>
                  <div class="controls input-medium" >
                      <input type="text" class='' required name="mst[diag_kode]" id="kode" size="5">
					  <i style="color:red;font-size:10px;">*harus sesuai standart ICD-X</i>
                  </div>
              ...
              <div class="control-group" style="border:none;">
                  ...
                  <div class="controls" >
                      <input type="text" class='' required name="mst[diag_name]" id="nama_diagnosa">
                  </div>
              </div>
              <div class="control-group" style="border:none;">
				...
				<div class="control-group" style="border:none;">
                  ...
                  <div class="controls" >
                      <input type="text" class='' required name="mst[indonesian]" id="indonesian">
                  </div>
              </div>
        ...
        <div class="widgetbox">
            ...
            <?=form_open(cur_url().'search',array('class' => 'form-horizontal frm_search stdform','id' => 'form')); ?>
              <div class="chatsearch" >
                  <input type="text" class='searchname' name="nama_dokter" placeholder="Cari Diagnosa" style="wi dth:91%;margin:auto;">
              </div>
  ...
  <div class="row-fluid">
    <div class="span12">
      ...
      <div class="black_loader">
        ...
        <div class="row-fluid list_diagnosa">
