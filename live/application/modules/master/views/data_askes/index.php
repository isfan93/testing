...
<script type="text/javascript">
  function reloadTable(){
      var url_hasil="<?php echo base_url()?>master/data_askes/loaddata"
  ...
  $(function(){
            ...
            if (r == true) {
                  ...
                  $(".black_loader").fadeIn(300).fadeOut(function(){
                    // console.log($(t).attr('href'));
                     $.ajax({
                        url: "<?php echo base_url()?>master/data_askes/delete_list",
      ...
      $.ajax({
        url: '<?php echo base_url()?>master/data_askes/loaddata',
        type: "POST",
        crossDomain: true,
      ...
      $('.submit').click(function(){
          isvalid = $("form.tambahData").validate({
            ...
            submitHandler: function(form) {                
                ...
                $(".black_loader").fadeIn(300).fadeOut(function(){
                  $.post( "<?=base_url()?>master/data_askes/create",formdata).done(function(){
      ...
      $('.submitEdit').live("click",function(){
          ...
          crsf = $('.crsf').val();
          url = "<?=base_url()?>master/data_askes/update";
      ...
      <div class="span11">
        <div class="widget-box">
          <div class="widget-title">
            ...
            <h5>Tambah Data Askes</h5>
          </div>
          
          <label class="control-label">Nama askes</label>
          <div class="controls">
            <input type="text" autofocus="" name="ds[ins_name]" id="ins_name" placeholder="Nama Asuransi Kesehatan">
          </div>
        ...
        <div class="widgetbox">
            ...
            <?=form_open(cur_url().'search',array('class' => 'form-horizontal frm_search stdform','id' => 'form')); ?>
              <div class="chatsearch" >
                  <input type="text" class='searchname' name="nama_dokter" placeholder="Cari askes" style="wi dth:91%;margin:auto;">
              </div>
