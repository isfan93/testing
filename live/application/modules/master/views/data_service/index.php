...
<script type="text/javascript">
  function reloadTable(){
      var url_hasil="<?php echo base_url()?>master/data_service/loaddata"
  ...
  $(function(){
            ...
            if (r == true) {
                  ...
                  $(".black_loader").fadeIn(300).fadeOut(function(){
                    // console.log($(t).attr('href'));
                     $.ajax({
                        url: "<?php echo base_url()?>master/data_service/delete_list",
      ...
      $.ajax({
        url: '<?php echo base_url()?>master/data_service/loaddata',
        type: "POST",
        crossDomain: true,
      ...
      $('.submit').click(function(){
          isvalid = $("form.tambahData").validate({
            ...
            submitHandler: function(form) {                
                ...
                $(".black_loader").fadeIn(300).fadeOut(function(){
                  $.post( "<?=base_url()?>master/data_service/create",formdata).done(function(){
      ...
      $('.submitEdit').live("click",function(){
          t = this;
          ins_id =  $(this).parent().parent().parent().find('.service_id').val();
          ins_name =  $(this).parent().parent().parent().find('.dsim_name').val();
          
          crsf = $('.crsf').val();
          url = "<?=base_url()?>master/data_service/update";
          datapost = "csrf_jike_2012="+crsf+"&ds[service_name]="+ins_name+"&ds[service_id]="+ins_id;
    ...
    <form class="stdform form-horizontal tambahData" style="display:none" method="post" >
      ...
      <div class="span11">
        <div class="widget-box">
          ...
          <div class="controls">
            <input type="text" autofocus="" name="ds[service_name]" id="service_name" placeholder="Jenis Pelayanan">
          </div>
        ...
        <div class="widgetbox">
            ...
            <?=form_open(cur_url().'search',array('class' => 'form-horizontal frm_search stdform','id' => 'form')); ?>
              <div class="chatsearch" >
                  <input type="text" class='searchname' name="nama_dokter" placeholder="Cari Jenis Pelayanan" style="wi dth:91%;margin:auto;">
              </div>
