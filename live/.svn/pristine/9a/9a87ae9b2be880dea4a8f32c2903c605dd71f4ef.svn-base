...
INSERT IGNORE INTO `sys_menu` (`menu_id`, `menu_parent`, `menu_url`, `menu_name`, `menu_status`, `modul_id`, `modi_id`, `modi_datetime`) VALUES
	(1, 0, 'pendaftaran/pendaftaran_baru', 'pendaftaran baru', 1, 1, NULL, '2014-06-21 22:52:38'),
	(2, 0, 'pendaftaran/pendaftaran_rawat_jalan', 'pendaftaran rawat jalan', 1, 1, NULL, '2014-07-07 20:31:33'),
	(3, 0, 'pendaftaran/pendaftaran_rawat_inap', 'pendaftaran rawat inap', 1, 1, NULL, '2014-06-21 22:52:39'),
	(4, 0, 'pendaftaran/IGD', 'IGD', 1, 1, NULL, '2014-07-08 13:24:12'),
	...
	(22, 0, 'pendaftaran/daftar_pasien', 'daftar pasien', 1, 1, NULL, '2014-07-08 13:24:16'),
