...
<div class="pageheader notab">
	<div class="row-fluid">
		...
		<div class="span6">
			<form class="form-inline" id="getFarmasi" action="<?=base_url()?>pelaporan/farmasi/getPengeluaran" method="POST">
