...
<script type="text/javascript">
  function reloadTable(){
      var url_hasil="<?php echo base_url()?>master/data_pavillion/loaddata"
  ...
  $(function(){
      ...
      // alert('asd');
      t = this;
     var r = confirm("Anda yakin akan mengaktifkan data ini ?");
        if (r == true) {
      ...
      return false;
  		...
  		$(".delete_data").on("click",function(e){
  			...
  			if(id_array!=0){
         var r = confirm("Anda yakin akan menonaktifkan data ini ?");
            if (r == true) {
          
                  $(".black_loader").fadeIn(300).fadeOut(function(){
                    // console.log($(t).attr('href'));
                     $.ajax({
                        url: "<?php echo base_url()?>master/data_pavillion/delete_list",
      ...
      $.ajax({
        url: '<?php echo base_url()?>master/data_pavillion/loaddata',
        type: "POST",
        crossDomain: true,
      ...
      $('.submit').click(function(){
          isvalid = $("form.tambahData").validate({
            ...
            submitHandler: function(form) {                
                ...
                $(".black_loader").fadeIn(300).fadeOut(function(){
                  $.post( "<?=base_url()?>master/data_pavillion/create",formdata).done(function(){
      ...
      $('.submitEdit').live("click",function(){
          t = this;
          ins_id =  $(this).parent().parent().parent().find('.pavillion_id').val();
          ins_name =  $(this).parent().parent().parent().find('.dsim_name').val();
          
          crsf = $('.crsf').val();
          url = "<?=base_url()?>master/data_pavillion/update";
          datapost = "csrf_jike_2012="+crsf+"&ds[pavillion_name]="+ins_name+"&ds[pavillion_id]="+ins_id;
    ...
    <form class="stdform form-horizontal tambahData" style="display:none" method="post" >
      ...
      <div class="span11">
        <div class="widget-box">
          ...
          <label class="control-label">Nama Pavillion</label>
          <div class="controls">
            <input type="text" autofocus="" name="ds[pavillion_name]" id="pavillion_name" placeholder="Nama Pavillion">
          </div>
        ...
        <div class="widgetbox">
            ...
            <?=form_open(cur_url().'search',array('class' => 'form-horizontal frm_search stdform','id' => 'form')); ?>
              <div class="chatsearch" >
                  <input type="text" class='searchname' name="nama_dokter" placeholder="Cari pavillion" style="wi dth:91%;margin:auto;">
              </div>
