...
$(function(){
	...
	isvalid = $("#form_finish").validate({
        ...
        submitHandler: function(form) {
            ...
            var url  = "<?=base_url()?>rawat_jalan/<?=$url_poli?>/finish_pemeriksaan";
...
<div>
	<div style="padding:10px;">
		<?=form_open(base_url().'rawat_jalan/'.$url_poli.'/finish_pemeriksaan',array('class' => 'form-horizontal','id' => 'form_finish')); ?>
		...
		<div class="form-actions" style="margin-bottom:0px;">
			<button type="button"  class="btn btn-primary simpan pull-right" value="">Selesai</button>
