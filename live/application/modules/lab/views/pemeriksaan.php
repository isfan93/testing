					    		...
					    		foreach ($pemeriksaan->result() as $key => $value) {
					    			...
					    			?>
					    				<tr>
					    					...
					    					<td style="text-align:center;"><b>LABORATORIUM</b></td>
					    					<td style="text-align:center;">
								            	<a href="<?=base_url('lab/cetak_hasil_pemeriksaan')?>/<?=$value->service_id?>" target="_blank" class="btn btn-primary btn-small">Cetak</a>
								            </td>
					    				</tr>
					    			<?php
					    		}
