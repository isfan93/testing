...
<script type="text/javascript">
  function reloadTable(){
    var url_hasil="<?php echo base_url()?>pelayanan_informasi/data_bed/loaddata"
    ...
    //=========== end del
        ...
        jQuery('.tgl_frm').val(getDateRaw(0)); 
          ...
          crsf = $('.crsf').val();
           ...
           $.ajax({
                          url: '<?php echo base_url()?>pelayanan_informasi/data_bed/loaddata',
                          type: "POST",
                          crossDomain: true,
          ...
          <div class="widget-title">
            ...
            <h5>Tambah Data</h5>
				...
				<div class="controls" >					
				 ...
				 <div class="controls">
					 <select name='mst[room_id]' required id='tipe_room' >
						...
						<option value="<?=$rows->room_id?>"><?=$rows->room_id?></option>
				...
				<label class="control-label" >Status</label>
				 <div class="controls">
					 <select name='mst[bed_status]' required id='bed_status' >
						<option value="">-- Pilih --</option>						
