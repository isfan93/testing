    ...
    $(function(){
    	 $('.tabel-master').dataTable( {
              ...
              { "bSortable": true, "aTargets": [ 1 ],"sWidth":"7%" },
					  ...
					  { "bSortable": false, "aTargets": [ 3 ],"sWidth":"40%" },
 ...
 <table cellpadding="0" cellspacing="0" border="0" class="tabel-master table table-bordered def_table_y dataTable tb_scrol">
    <thead>
      <tr  role="row">
        ...
        <th class="head1">Nama Golongan</th>
    ...
    <?php $i=1; foreach ($datas->result() as $list):?>
      <tr>
        ...
        <td><div class='shows'><?=$list->golongan_name?></div><input class="hiddens dsim_name" name='' type="text" value="<?=$list->golongan_name?>" ></td>
        <td><div class='shows'><?=$list->description?></div><input class="hiddens dsim_desc" name='' type="text" value="<?=$list->description?>" ></td>
        <td class="center"> 
          <div class='shows'>
            <a class="buttons btn_pencil" style="" href="<?=base_url()?>master/data_lab_treathment_gol/edit_list/<?=$list->id?>"></a>
            <a class="buttons btn_trash" style="margin-left:10px;" href="<?=base_url()?>master/data_lab_treathment_gol/delete_list/<?=$list->id?>"></a>
          </div>
          <div class="hiddens">
