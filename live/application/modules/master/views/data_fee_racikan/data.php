 ...
 <table cellpadding="0" cellspacing="0" border="0" class="tabel-master table table-bordered def_table_y dataTable tb_scrol">
    ...
    <?php $i=1; foreach ($datas->result() as $list):?>
      <tr>
        ...
        <td class="center"> 
          <div class='shows'>
            <a class="buttons btn_pencil" style="" href="<?=base_url()?>master/data_fee_racikan/edit_list/<?=$list->id?>"></a>
            <a class="buttons btn_trash" style="margin-left:10px;" href="<?=base_url()?>master/data_fee_racikan/delete_list/<?=$list->id?>"></a>
          </div>
          <div class="hiddens">
