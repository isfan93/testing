...
<script type="text/javascript" charset="utf-8">
	...
	$(function(){
		...
		var d_uri = "<?=base_url()?>gudang/retur/get_retur";
...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="span3" >
			<div class="title"><h3>Retur Inventori</h3></div>
		</div>
	</div>
	<div class="row-fluid">
		<div class="span7">
            <div class="widgetbox" style="float:left;padding-top:20px;padding-left:20px;">
				<a href="<?php echo(cur_url())?>add_retur" class="btn btn-primary">
		...
		<div class="widgetbox">
			<div class="span12">
				...
				<table class="table table-bordered table-striped table_tr tb_scrol" id="dyntable">
				    <thead>
				        <tr>
				        	<th style="width:10% !important;">No. Retur</th>
				            <th style="width:13% !important;">No. Faktur</th>
				            <th style="width:13% !important;">Tanggal Retur</th>
