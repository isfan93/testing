...
<script type="text/javascript">
  function reloadTable(){
      var url_hasil="<?php echo base_url()?>master/data_racikan_fee/loaddata"
      $(".list_racikan_fee").load(url_hasil);
  }
  ...
  $(function(){
            ...
            if (r == true) {
                  ...
                  $(".black_loader").fadeIn(300).fadeOut(function(){
                    // console.log($(t).attr('href'));
                     $.ajax({
                        url: "<?php echo base_url()?>master/data_racikan_fee/delete_list",
      ...
      $('.list_racikan_fee').children().remove();
      $.ajax({
        url: '<?php echo base_url()?>master/data_racikan_fee/loaddata',
        type: "POST",
        crossDomain: true,
      ...
      $('.submit').click(function(){
          isvalid = $("form.tambahData").validate({
            ...
            submitHandler: function(form) {                
                ...
                $(".black_loader").fadeIn(300).fadeOut(function(){
                  $.post( "<?=base_url()?>master/data_racikan_fee/create",formdata).done(function(){
      ...
      $('.submitEdit').live("click",function(){
		  ...
		  ins_tarif =  $(this).parent().parent().parent().find('.dsim_fee').val();
          
          crsf = $('.crsf').val();
          url = "<?=base_url()?>master/data_racikan_fee/update";
          datapost = "csrf_jike_2012="+crsf+"&ds[description]="+ins_name+"&ds[id]="+ins_id+"&ds[fee]="+ins_tarif;
      ...
      <div class="span5">
        <div class="widget-box">
          <div class="widget-title">
            ...
            <h5>Tambah Data Tarif Racikan</h5>
          </div>
          
          <label class="control-label">Nama Kemasan</label>
          <div class="controls">
            <input type="text" autofocus="" name="ds[description]" id="desc" placeholder="Nama Kemasan">
          </div>
		  <label class="control-label">Tarif</label>
          <div class="controls">
            <input type="text" autofocus="" name="ds[fee]" id="ins_tarif" placeholder="Nominal">
          </div>
        ...
        <div class="widgetbox">
            ...
            <?=form_open(cur_url().'search',array('class' => 'form-horizontal frm_search stdform','id' => 'form')); ?>
              <div class="chatsearch" >
                  <input type="text" class='searchname' name="nama_dokter" placeholder="Cari Kemasan" style="wi dth:91%;margin:auto;">
              </div>
  ...
  <div class="row-fluid">
    <div class="span12">
      ...
      <div class="black_loader">
        ...
        <div class="row-fluid list_racikan_fee">
