    ...
    $(function(){
    	 $('.tabel-master').dataTable( {
                ...
                "aoColumnDefs": [
					  ...
					  { "bSortable": false, "aTargets": [ 3 ],"sWidth":"3%" }
				   ],
                "oLanguage": {
 ...
 <table cellpadding="0" cellspacing="0" border="0" class="tabel-master table table-bordered def_table_y dataTable tb_scrol">
    <thead>
      <tr  role="row">
        ...
        <th class="head1">Nama Tindakan Lab</th>
      ...
      <tr>
        ...
        <td class="center"> 
          <div class='shows'>
            ...
            <a class="buttons btn_trash" style="margin-left:10px;" href="<?=base_url()?>master/data_tindakan_lab/delete_list_detail/<?=$list->id_map?>"></a>
          </div>
          <div class="hiddens">
