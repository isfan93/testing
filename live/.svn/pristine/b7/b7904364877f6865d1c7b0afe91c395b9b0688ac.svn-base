...
<div class="pageheader notab">
	<div class="row-fluid">
		...
		<div class="span8">
			<form class="form-inline" id="getKunjungan" action="<?=base_url()?>pelaporan/kunjungan/getRawatJalan" method="POST">
		        ...
		        <div  style="margin-top:10px;float:right;margin-right:20px;">
                    ...
                    <!-- Hendri, 23 April 2015 -->
                    <label class="control-label"> Jenis Kelamin </label> 
                        <select class="input input-small" name="sex">
...
<script type="text/javascript">
	$(function(){
		$("#getKunjungan").on('submit',function(){
			$.blockUI({
