				...
				<div class="body-surat">
					<div class="span12">
						<div class="text-body-surat">
							...
							<p>
								Telah kami periksa dengan hasil yang menjelaskan bahwa yang bersangkutan dalam keadaan <br><b> tidak buta warna / buta warna</b>
							</p>
							<p>
							...
							<p>
								...
								<?=!empty($surat->ref_description) ? $surat->ref_description : '-'?>
							</p>
						</div>
					</div>
