...
-- Dumping structure for table simrsih.ptn_family
...
-- Dumping data for table simrsih.ptn_family: ~0 rows (approximately)
/*!40000 ALTER TABLE `ptn_family` DISABLE KEYS */;
/*!40000 ALTER TABLE `ptn_family` ENABLE KEYS */;
