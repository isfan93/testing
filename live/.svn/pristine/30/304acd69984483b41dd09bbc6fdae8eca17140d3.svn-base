		...
		<div class="span7">
			...
			<thead>
				<tr role="row">
					...
					<th class="sorting" role="columnheader" tabindex="0" aria-controls="src_table" rowspan="1" colspan="1" style="width:30%" aria-label="Harga: activate to sort column ascending">Nama Pasien/ No. RM</th>
					<th class="sorting" role="columnheader" tabindex="0" aria-controls="src_table" rowspan="1" colspan="1" style="width:20%" aria-label="Aksi: activate to sort column ascending">Alamat</th>
					<th class="sorting" role="columnheader" tabindex="0" aria-controls="src_table" rowspan="1" colspan="1" style="width:10%" aria-label="Aksi: activate to sort column ascending">Status</th>
				</tr>
			</thead>
			<tbody>
				<?php
